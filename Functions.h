...
namespace Functions {
void demonstrate_functions();  // function prototypes go within the namespace
                               // (if needed)
void demonstrate_pass_by_value(int,
                               int);  // returnType functionName(parameters)
...
void demonstrate_pass_by_value(int num1, int num2) {
...
void demonstrate_pass_by_ref(int& num1, int& num2) {
...
void demonstrate_pass_by_address(int* num1, int* num2) {
